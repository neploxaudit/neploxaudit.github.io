...
Ciao is a **welcome** challenge released at the very beginning of the **BlazCTF**. This is a textbook example of a **sanity check** CTF task. Its description implies that participants must look closely at the given transaction to discover _a hidden treasure_.
...
```sol title="solution.sol" test="test"
...
<blockquote>
<p>Tony, a web3 whiz, scoured blockchain transactions for hidden treasures. His diligence struck gold when he uncovered <a href="https://arbiscan.io/tx/0xd58271ed821a19fa5af95245e2be55782cad67f46556aa437e1af157267ce6d4">a lucrative transaction</a> others had overlooked.<br></p>
